...
win.requestAnimationFrame = function (callback: FrameRequestCallback) {
  return 0;
};
(global['window'] as any) = win;
// (global['self'] as any) = win;
(global['document'] as any) = win.document;
(global['navigator'] as any) = win.navigator;
(global['Event'] as any) = null;
